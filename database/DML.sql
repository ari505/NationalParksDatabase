...
DELETE FROM Reservations_has_Participants WHERE reservation_id = #reservation_id

--******************
--All UPDATE Queries
--******************

--UPDATE Camping Start and End Dates in Reservations

UPDATE Reservations SET camping_start_date = #camping_start_date WHERE reservation_id = #reservation_id_of_row_chosen_for_update
UPDATE Reservations SET camping_end_date = #camping_end_date WHERE reservation_id = #reservation_id_of_row_chosen_for_update

--UPDATE Campground ID in Reservations, which is NULLable

UPDATE Reservations SET campground_id = #campground_id WHERE reservation_id = #reservation_id_of_row_chosen_for_update
